...
export default function Privacy() {
  return (
    <>
      <Head>
        <title>Money CEO – Privacy Policy</title>
      ...
      <main className="container">
        ...
        <p className="note">
          We respect your privacy. This site stores transactions in your
          browser's local storage only. No personal data is sent to a
          server. Please do not enter sensitive information in free text
          fields.
        </p>
      </main>
    </>
